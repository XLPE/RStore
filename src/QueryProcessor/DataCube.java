...
public class DataCube {	
	...
	public DataCube(String tableName, String schemaPath){
    ...
    public boolean checkOperator(){
    	// check filter
    	for(String c: cubeFilter.columnList){
    		if(!table.columns.containsKey(c)){
    			System.out.println("filter condition of column " + c + " does not exist in table");
    			return false;
    		}
    		if(!cuboid.columnIndex.containsKey(c)){
    			System.out.println("filter condition of column " + c + " does not exist in cube");
    			return false;
    		}
    	}
    	// check filter
    	for(String c: groupBy.groupedColumns){
    		if(!table.columns.containsKey(c)){
    			System.out.println("grouped column " + c + " does not exist in table");
    			return false;
    		}
    		if(!cuboid.columnIndex.containsKey(c)){
    			System.out.println("grouped column " + c + " does not exist in cube");
    			return false;
    		}
    	}
    	return true;
	...
	public void execute(){
    	if(!checkOperator()){
    		System.out.println("grammer error!");
    		return;
    	}
    	setTimeStamp();
