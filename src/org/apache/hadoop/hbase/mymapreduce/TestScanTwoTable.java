...
public class TestScanTwoTable {
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
		...
		job.setJarByClass(TestScanTwoTable.class);     // class that contains mapper and reducer
		...
		FileOutputFormat.setOutputPath(job, new Path("/tmp/timestmaps"));  // adjust directories as required
