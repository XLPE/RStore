...
public class BatchRealtimeQueryingLineitem {

	public static class BuildingCubeLineMapper extends
	...
	public static class BuildingCubeLineReducer
			extends
	...
	public static void main(String args[]) throws ParseException, IOException,
		...
		Job job = new Job(config, "Batch Real Time Querying");
		job.setJarByClass(BatchRealtimeQueryingLineitem.class); // class that
																// contains
																// mapper and
																// reducer
		...
		TableMapReduceUtil.initTableMapperJob("line", // input table
				...
				BuildingCubeLineMapper.class, // mapper class
		...
		TableMapReduceUtil.initTableReducerJob(datacubeName, // output table
				BuildingCubeLineReducer.class, // reducer class
				job);
