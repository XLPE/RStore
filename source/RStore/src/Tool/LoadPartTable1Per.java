...
public class LoadPartTable1Per {
	...
	public static void main(String[] args) throws IOException {
		...
		LoadPartTable1Per update = new LoadPartTable1Per();
		int printout = numOfUpdate / 100;
		int batchFactor = 200;
		int t = 0;
		for (int i = 0; i < numOfUpdate / batchFactor; i+=2) {
			...
			for (int k = 0; k < batchFactor; k++) {
				int key = ((index * numOfUpdate + (i *batchFactor + k))/200) * 200;
				String keyStr = key + "";
				//System.out.println(keyStr + "   " + update.generatePartValue() );
