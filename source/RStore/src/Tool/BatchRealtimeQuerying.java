...
public class BatchRealtimeQuerying {
	...
	public static void main(String args[]) throws ParseException, IOException, InterruptedException, ClassNotFoundException{
		...
		job.setJarByClass(BatchRealtimeQuerying.class);     // class that contains mapper and reducer
		...
		TableMapReduceUtil.initTableReducerJob(
			...
			job);			
		//job.setCombinerClass(BuildingCubeReducer.class);
